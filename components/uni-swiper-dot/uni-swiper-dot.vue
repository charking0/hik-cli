<template>
	<view class="uni-swiper__warp">
		<slot />
		<view :style="{'bottom':dots.bottom + 'px'}" class="uni-swiper__dots-box" key='round'>
			<view v-for="(item,index) in len" @click="clickItem(index)" :class="[index === current&&'uni-swiper__dots-long']" :style="{
		...
		data() {
			return {
				dots: {
					...
					selectedBackgroundColor: '#F45C24',
					selectedBorder: '1px rgba(244, 92, 36, .9) solid'
				}
			}
		},
		watch: {
