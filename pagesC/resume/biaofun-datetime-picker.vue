...
<template>
	<view class="datatime" >
		<picker mode="multiSelector" :range="range" range-key="text" @change="change" @columnchange="columnchange" :value="value" :disabled="disabled" class="picker">
			<view class="content" :class="{ placeholder: !dateStr }">
				<view>{{ dateStr ? dateStr : placeholder }}</view>
			</view>
		</picker>
	</view>
</template>
